...
public class Chart_test extends JFrame {
    ...
    // private
    private MyCanvas trendChartCanvas = new MyCanvas(); //创建画布
    // 框架起点坐标
    private final int FREAME_X = 50; //起点
    private final int FREAME_Y = 50;
    private final int FREAME_WIDTH = 600;// 横
    private final int FREAME_HEIGHT = 250;// 纵

    // 原点坐标
    private final int Origin_X = FREAME_X + 50;  //留空间给标签
    private final int Origin_Y = FREAME_Y + FREAME_HEIGHT - 30;//跳到左下角

    // X,Y轴终点坐标
    private final int XAxis_X = FREAME_X + FREAME_WIDTH - 30;//边界往里收一点点
